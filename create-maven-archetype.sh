...
sed -i.bk "s|graalvm-blank|projectName|g" pom.xml
sed -i.bk "s|github\.com/making/projectName|github.com/making/graalvm-blank|g" pom.xml
mv src/main/resources/META-INF/native-image/am.ik.archetype/graalvm-blank src/main/resources/META-INF/native-image/am.ik.archetype/projectName
...
sed -i.bk "s|projectName|graalvm-blank|g" pom.xml
